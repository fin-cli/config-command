Feature: List the values of a fin-config.php file

  Scenario: List constants, variables and files included from fin-config.php
  ...
  Scenario: List constants, variables and files included from fin-custom-config.php
    Given an empty directory
    And FIN files
    And a fin-config-extra.php file:
      """
    ...
    When I run `fin config list --fields=name,type --config-file='fin-custom-config.php'`
    Then STDOUT should be a table containing rows:
      | name               | type     |
      | DB_NAME            | constant |
      | DB_USER            | constant |
  ...
  Scenario: Filter the list of values of a fin-config.php file
    Given an empty directory
    And FIN files
    ...
    When I run `fin config list --fields=name`
    Then STDOUT should be a table containing rows:
      | name             |
      | table_prefix     |
      | DB_NAME          |
    ...
    When I run `fin config list --fields=name DB_`
    Then STDOUT should be a table containing rows:
      | name        |
      | DB_NAME     |
      | DB_USER     |
    ...
    When I run `fin config list --fields=name DB_HOST`
    Then STDOUT should be a table containing rows:
      | name    |
      | DB_HOST |
    And STDOUT should not contain:
    ...
    When I try `fin config list --fields=name --strict`
    Then STDERR should be:
      """
      Error: The --strict option can only be used in combination with a filter.
      """

    When I try `fin config list --fields=name DB_ --strict`
    Then STDERR should be:
      """
      Error: No matching entries found in 'fin-config.php'.
      """

    When I run `fin config list --fields=name DB_USER DB_PASSWORD`
    Then STDOUT should be a table containing rows:
      | name        |
      | DB_USER     |
      | DB_PASSWORD |
    ...
    When I run `fin config list --fields=name DB_USER DB_PASSWORD --strict`
    Then STDOUT should be a table containing rows:
      | name        |
      | DB_USER     |
      | DB_PASSWORD |
    ...
    When I run `fin config list --fields=name _KEY _SALT`
    Then STDOUT should be a table containing rows:
      | name             |
      | AUTH_KEY         |
      | SECURE_AUTH_KEY  |
  ...
  Scenario: Filter the list of values of a fin-custom-config.php file
    Given an empty directory
    And FIN files
    ...
    When I run `fin config list --fields=name --config-file='fin-custom-config.php'`
    Then STDOUT should be a table containing rows:
      | name             |
      | table_prefix     |
      | DB_NAME          |
    ...
    When I run `fin config list --fields=name DB_ --config-file='fin-custom-config.php'`
    Then STDOUT should be a table containing rows:
      | name        |
      | DB_NAME     |
      | DB_USER     |
    ...
    When I run `fin config list --fields=name DB_HOST --config-file='fin-custom-config.php'`
    Then STDOUT should be a table containing rows:
      | name    |
      | DB_HOST |
    And STDOUT should not contain:
    ...
    When I try `fin config list --fields=name --strict --config-file='fin-custom-config.php'`
    Then STDERR should be:
      """
      Error: The --strict option can only be used in combination with a filter.
      """

    When I try `fin config list --fields=name DB_ --strict --config-file='fin-custom-config.php'`
    Then STDERR should be:
      """
      Error: No matching entries found in 'fin-custom-config.php'.
      """

    When I run `fin config list --fields=name DB_USER DB_PASSWORD --config-file='fin-custom-config.php'`
    Then STDOUT should be a table containing rows:
      | name        |
      | DB_USER     |
      | DB_PASSWORD |
    ...
    When I run `fin config list --fields=name DB_USER DB_PASSWORD --strict --config-file='fin-custom-config.php'`
    Then STDOUT should be a table containing rows:
      | name        |
      | DB_USER     |
      | DB_PASSWORD |
    ...
    When I run `fin config list --fields=name _KEY _SALT --config-file='fin-custom-config.php'`
    Then STDOUT should be a table containing rows:
      | name             |
      | AUTH_KEY         |
      | SECURE_AUTH_KEY  |
  ...
  Scenario: Configuration can be formatted for dotenv files
    ...
    When I run `fin config list --format=dotenv`
    Then STDOUT should be:
      """
      DB_NAME='fin_cli_test'
      DB_USER='fin_cli_test'
